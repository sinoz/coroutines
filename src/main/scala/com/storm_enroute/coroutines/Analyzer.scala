...
import com.storm_enroute.coroutines.common.ByTreeUntyper
...
trait Analyzer[C <: Context] {
  ...
  class VarInfo(
    ...
    def pushTree(implicit t: Table): Tree = {
      if (isWide) {
        ...
        q"""
          ...
          _root_.com.storm_enroute.coroutines.common.Stack.push[$stacktpe](
    ...
    def popTree = {
      if (isWide) q"""
        _root_.com.storm_enroute.coroutines.common.Stack.pop[$stacktpe]($$c.$stackname)
        _root_.com.storm_enroute.coroutines.common.Stack.pop[$stacktpe]($$c.$stackname)
      """ else q"""
        _root_.com.storm_enroute.coroutines.common.Stack.pop[$stacktpe]($$c.$stackname)
      """
    ...
    def storeTree(coroutine: Tree, x: Tree): Tree = {
      if (isWide) {
        ...
        q"""
          ...
          _root_.com.storm_enroute.coroutines.common.Stack.set[$stacktpe](
    ...
    def loadTree(coroutine: Tree): Tree = {
      if (isWide) {
        ...
        q"""
          val $nme0 = _root_.com.storm_enroute.coroutines.common.Stack.get[$stacktpe](
            $coroutine.$stackname, ${stackpos._1 + 0})
          val $nme1 = _root_.com.storm_enroute.coroutines.common.Stack.get[$stacktpe](
        ...
        if (isUnitType) q"()"
          ...
          val t = q"""
            _root_.com.storm_enroute.coroutines.common.Stack.get[$stacktpe](
